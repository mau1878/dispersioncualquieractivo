...
data['Dispersión'] = (data[price_column] - data[sma_label]).astype(float)

# Calcular el porcentaje de dispersión
data['Porcentaje_Dispersión'] = ((data[price_column] - data[sma_label]) / data[sma_label] * 100).astype(float)
